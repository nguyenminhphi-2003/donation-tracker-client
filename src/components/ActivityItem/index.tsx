export default function ActivityItem({ activity } : any) {
    ...
    const fullName = creator == null ? 'Community' : `${creator.firstName} ${creator.lastName}`;
    ...
    return (
        <div className='border border-gray-300 rounded-lg shadow-sm max-w-80'>
            ...
            <div className="px-2">
                <h1 className='text-lg font-semibold mb-1 hover:text-primary-pink text-gray-800 transition-all cursor-pointer'>{name}</h1>
                <p className='mb-1'>Creator: {fullName}</p>
                <p className='mb-1'>Total: {totalDonations}/{goalAmount}</p>
